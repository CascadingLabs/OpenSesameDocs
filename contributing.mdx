---
title: Contributing
description: How to contribute to the OpenSesame documentation and who maintains the project.
slug: contributing
---

import { Steps } from '@astrojs/starlight/components';

Thanks for your interest in contributing to OpenSesame Docs! This guide covers how to get set up and what we expect from pull requests.
...
1. Clone the repository
   ...
   ```bash
   git clone https://github.com/CascadingLabs/OpenSesameDocs.git
   cd OpenSesameDocs
   bun install
   ```
...
We use [GitHub issue forms](https://github.com/CascadingLabs/OpenSesameDocs/issues/new/choose) for all issues. Pick the template that fits:
